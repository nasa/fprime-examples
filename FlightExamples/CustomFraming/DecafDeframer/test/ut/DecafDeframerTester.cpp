// ======================================================================
// \title  DecafDeframerTester.cpp
// \author thomas-bc
// \brief  cpp file for DecafDeframer component test harness implementation class
// ======================================================================
...
DecafDeframerTester ::DecafDeframerTester()
    : DecafDeframerGTestBase("DecafDeframerTester", DecafDeframerTester::MAX_HISTORY_SIZE), component("DecafDeframer") {
    this->initComponents();
    this->connectPorts();
}
...
void DecafDeframerTester ::testNominalFrame() {
...
void DecafDeframerTester ::testIncorrectStartWord() {
...
void DecafDeframerTester::testZeroSizeFrame() {
...
void DecafDeframerTester::testDataReturn() {
    U8 data[1];
...
void DecafDeframerTester::injectChecksum(U8* data, FwSizeType size) {
...
void DecafDeframerTester::mockReceiveData(U8* data, FwSizeType size) {
    ComCfg::FrameContext nullContext;
